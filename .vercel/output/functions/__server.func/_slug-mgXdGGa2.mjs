...
*/
function AudioNarration({ audio, duration: knownDuration }) {
...
*/
function SpeechNarration({ containerRef }) {
...
function ListenToArticle({ containerRef, narration }) {
	if (narration) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioNarration, { ...narration });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpeechNarration, { containerRef });
}
