...
import { t as Route } from "./_slug-BvYz927f.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-B8Um92Ny.js
...
function ListenToArticle({ containerRef }) {
	...
	if (status === "idle") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [
			...
			totalBaseline > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "font-mono text-[12px] tabular-nums text-muted-foreground",
				children: formatClock(totalBaseline)
			})
		]
	});
	const progressPct = totalBaseline > 0 ? Math.min(100, elapsed * rate / totalBaseline * 100) : 0;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "ml-2 w-[3ch] shrink-0 font-mono text-[13px] tabular-nums text-foreground/80",
